...
export const projects = [
  {
    ...
    cover: { src: "/assets/img/life-through-water/front.jpg", alt: "The caravan installation exterior, painted with a Nordhavn map graphic" },
    gallery: [
      { src: "/assets/img/life-through-water/screenshot-1.jpg", alt: "Projected footage of a diver wrapping the interior walls of the caravan" },
      { src: "/assets/img/life-through-water/screenshot-2.jpg", alt: "Visitor interacting with a projected scene using a wooden object" },
      { src: "/assets/img/life-through-water/screenshot-3.jpg", alt: "The caravan installation on-site as part of the exhibition" },
      { src: "/assets/img/life-through-water/screenshot-4.jpg", alt: "The Myths & Bricks info point sign next to the caravan" },
    ],
    video: { src: "/assets/video/life-through-water-trailer.mp4", poster: "/assets/img/life-through-water/front.jpg" },
  },
  {
    id: "karensminde",
